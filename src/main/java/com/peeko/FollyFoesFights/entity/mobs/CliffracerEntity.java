package com.peeko.FollyFoesFights.entity.mobs;
...
public class CliffracerEntity extends MonsterEntity implements IMob{


    public CliffracerEntity(EntityType<? extends MonsterEntity> type, World worldIn) {
        super(type, worldIn);
    }
